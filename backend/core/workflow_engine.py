...
class AdvancedWorkflowEngine:
    ...
    def __init__(self, ai_assistant: KaliAIAssistant, command_engine: IntelligentCommandEngine, security_tools: SecurityToolManager):
    ...
    async def _thinking_phase(self, request: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ai_response = await self.ai_assistant.process_query(thinking_prompt, context)
